    ...
    describe('Basic Fields: name and userType', () => {
      describe('name', () => {
        ...
        it('name must be unique', async () => {
          // We shouldn't be able to create two users with the same name. SO USE NAME TEXT UNIQUE
        ...
        it('name cannot be null', async () => {
          // We shouldn't be able to create a user without a name. SO DO NAME TEXT NOT NULL
          await expect(
            User.create({}),
        ...
        it('name cannot be an empty string', async () => {
          // We also shouldn't be able to create a user with an empty name. MAYBE A DELETE FROM HERE?
          await expect(
            User.create({ name: '' }),
